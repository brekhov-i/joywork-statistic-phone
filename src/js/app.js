...
const spButton = Vue.component('sp-button', {
  props: [
    'color'
  ],
  emits: [],
...
const spCheckbox = Vue.component('sp-checkbox', {
  props: [
    'positionlabel',
    'title',
    'id'
...
const spDropdown = Vue.component('sp-dropdown', {
  props: [
    'options',
    'title',
    'icon',
...
const spInput = Vue.component('sp-input', {
  props: [
    'title',
    'mask',
    'value'
...
const spTable = Vue.component('sp-table', {
  props: [
    'data',
    'count'
  ],
